...
export const siteConfig: SiteConfig = {
  ...
  gitHubContributions: {
    ...
    username: "rigerc", // Your GitHub username
  ...
  gitHubRepo: {
    owner: "rigerc", // GitHub username or organization
    repo: "bsgb-nl", // Repository name
  ...
  socialFooter: {
    ...
    copyright: {
      siteName: "bsgb.nl", // Update with your site/company name
