...
const SITE_URL = process.env.SITE_URL || "https://bsgb-nl.netlify.app";
const SITE_NAME = "bsgb.nl";
...
function generateMetaHtml(content: {
  ...
  const siteUrl = process.env.SITE_URL || "https://bsgb-nl.netlify.app";
  const siteName = "bsgb.nl";
